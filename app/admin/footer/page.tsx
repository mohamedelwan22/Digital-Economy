...
const fields = [
  ...
  { key: 'footer_twitter', label: 'رابط تويتر', type: 'text' as const },
  { key: 'footer_instagram', label: 'رابط انستغرام', type: 'text' as const },
  { key: 'footer_linkedin', label: 'رابط لينكد إن', type: 'text' as const },
  { key: 'footer_youtube', label: 'رابط يوتيوب', type: 'text' as const },
  { key: 'footer_snapchat', label: 'رابط سناب شات', type: 'text' as const },
